...
-(void)changeItemState{
    ...
    if (self.model.type == MediaSelectItemType_IMG) {
        ...
        [self changeCenterImageViewShow:YES image:[UIImage iconWithInfo:TBCityIconInfoMake(IconFont_Play, 42, Color_white_1)]];
        [self changeBoxViewBorderShow:NO];
...
-(UIButton *)deleteButton{
    if (!_deleteButton) {
        ...
        _deleteButton.backgroundColor = Color_white_1;
        _deleteButton.layer.cornerRadius = 12;
    }
    return _deleteButton;
}

-(void)setModel:(MediaSelectItemModel *)model{
    _model = model;
